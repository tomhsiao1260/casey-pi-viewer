...
export default class ViewerCore {
  ...
  render() {
    ...
    if (this.params.mode === 'volume' || this.params.mode === 'volume-segment') {
      ...
      this.volumePass.material.uniforms.clim.value.set(this.params.climMin, this.params.climMax)
      ...
      this.volumePass.material.uniforms.renderthreshold.value = 0.0 // For ISO renderstyle
    ...
    if (this.params.mode === 'layer' || this.params.mode === 'grid layer') {
      ...
      this.layerPass.material.uniforms.clim.value.set(this.params.climMin, this.params.climMax)
